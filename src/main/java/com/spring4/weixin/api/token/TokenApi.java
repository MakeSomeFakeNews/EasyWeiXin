...
public class TokenApi {
	...
	private static String call_back_url = "https://api.weixin.qq.com/cgi-bin/getcallbackip?access_token=ACCESS_TOKEN";
	 ...
	 * @return access_token
	 */
	public static Access_Token get_access_token() {
	 ...
	 * @return 微信服务器IP
	 */
	public static String getCallBackIP(Access_Token access_token) {
