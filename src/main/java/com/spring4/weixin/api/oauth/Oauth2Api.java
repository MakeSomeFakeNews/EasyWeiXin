...
public class Oauth2Api {
	...
	public static String getSnsapi_baseUrl() {
	...
	public static String getSnsapi_userinfoUrl() {
		return baseUrl.replace("APPID", PropertiesUtil.getAppId())
	 ...
	 */
	public static Oauth2Token login(String code) {
	 ...
	 * @return 用户信息
	 */
	public static UserInfo getUserInfo(String access_token, String openid, String lang) {
	...
	private static String verify_access_token = "https://api.weixin.qq.com/sns/auth?access_token=ACCESS_TOKEN&openid=OPENID";
	 ...
	 */
	public static String verify_access_token() {
	 ...
	 */
	public static Oauth2Token get_refresh_token(String refreshToken) {
